...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2023 at 02:38 AM
...
CREATE TABLE `business_cards` (
  ...
  `theme_id` varchar(191) DEFAULT NULL,
  `theme_color` varchar(191) DEFAULT NULL,
  `card_lang` varchar(191) NOT NULL DEFAULT 'EN',
  `cover` longtext DEFAULT NULL,
  `profile` longtext DEFAULT NULL,
  `card_url` varchar(191) NOT NULL,
  `card_type` varchar(191) NOT NULL,
  `title` varchar(191) NOT NULL,
  `title2` varchar(100) DEFAULT NULL COMMENT 'lname from user table',
  ...
  `company_websitelink` varchar(256) DEFAULT NULL,
  `ccode` varchar(5) DEFAULT NULL,
  `phone_number` varchar(15) DEFAULT NULL,
  `card_email` varchar(50) DEFAULT NULL,
  `card_for` varchar(20) DEFAULT NULL,
...
(1, '63d8f2503c721', 128, '1', NULL, 'en', NULL, 'assets/uploads/avatar/md-mridul-63d8f2503c8c5.jpg', '63d8f2503c818', 'vcard', 'Md Mridul', NULL, NULL, NULL, 2, '2023-01-31 10:49:52', '2023-02-02 09:24:34', 'Arobil It', NULL, NULL, '+8801794798227', 'mdmridul608@gmail.com', 'Work', NULL, 'Web Developer', '2023-02-02 15:24:34', 1, NULL, NULL, 1, 1, 1, 0);
...
(1, 1, 'mobile', 'phone', 'assets/img/icon/call.svg', 9, 'Phone', '+8801794798227', 0000000001, '2', '2023-01-31 10:49:52', '2023-02-02 09:24:34'),
...
CREATE TABLE `gateways` (
  `id` int(10) UNSIGNED NOT NULL,
  `payment_gateway_logo` varchar(191) NOT NULL,
  `payment_gateway_name` varchar(191) NOT NULL,
  `display_name` varchar(191) NOT NULL,
  `client_id` varchar(191) NOT NULL,
  `secret_key` varchar(191) NOT NULL,
  `is_status` varchar(191) NOT NULL DEFAULT 'enabled',
  `status` varchar(191) NOT NULL DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `history_card_browsing` (
  ...
  `modified_by` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
...
CREATE TABLE `plans` (
  ...
  `personalized_link` varchar(191) NOT NULL,
  `hide_branding` varchar(191) NOT NULL,
  `free_setup` varchar(191) NOT NULL,
  `free_support` varchar(191) NOT NULL,
  `recommended` varchar(191) DEFAULT NULL,
  `is_watermark_enabled` varchar(191) NOT NULL,
  `features` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `plans_type` int(11) DEFAULT NULL,
  `name` varchar(190) DEFAULT '''''''default''''''',
  `slug` varchar(200) DEFAULT NULL,
  `stripe_plan_id` varchar(255) DEFAULT NULL,
  `stripe_data` longtext DEFAULT NULL,
  `stripe_data_yearly` varchar(100) DEFAULT NULL,
  `stripe_plan_id_yearly` text DEFAULT NULL,
  `paypal_plan_id` varchar(500) DEFAULT NULL,
  `paypal_plan_data` longtext DEFAULT NULL,
...
CREATE TABLE `products` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `product_name` varchar(255) NOT NULL DEFAULT 'FileService Credits',
...
CREATE TABLE `settings` (
  ...
  `pinterest_url` varchar(124) DEFAULT NULL,
  `main_motto` varchar(255) DEFAULT NULL,
  `site_disclimer` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `social_icon` (
  `id` int(10) UNSIGNED NOT NULL,
  `icon_group` enum('Recommended','Contact','Social Media','Music Media','Payment','More') NOT NULL,
  `icon_name` varchar(191) NOT NULL COMMENT 'need lowercase',
  `icon_image` varchar(255) DEFAULT NULL,
  `icon_fa` varchar(191) DEFAULT NULL,
  `icon_title` varchar(191) NOT NULL,
  `icon_color` varchar(155) DEFAULT NULL,
  `example_text` varchar(191) DEFAULT NULL,
  `status` int(1) NOT NULL DEFAULT 1 COMMENT '0=inactive,1=active',
  `order_id` int(11) NOT NULL DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `type` enum('mobile','number','text','username','link','mail','address','file') DEFAULT NULL,
  `main_link` varchar(124) DEFAULT NULL COMMENT 'if type is username',
...
CREATE TABLE `themes` (
  ...
  `theme_thumbnail` varchar(191) NOT NULL,
  `theme_price` varchar(191) NOT NULL,
  `status` varchar(191) NOT NULL DEFAULT '1',
...
CREATE TABLE `transactions` (
  `id` int(10) UNSIGNED NOT NULL,
  `gobiz_transaction_id` varchar(191) NOT NULL,
...
CREATE TABLE `users` (
  ...
  `billing_country_code` varchar(50) CHARACTER SET utf16 COLLATE utf16_general_ci DEFAULT NULL,
  ...
  `stripe_customer_id` varchar(500) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
  ...
  `designation` varchar(124) DEFAULT NULL,
  `company_name` varchar(124) DEFAULT NULL,
  `company_websitelink` varchar(124) DEFAULT NULL,
  ...
  `connection_title` varchar(155) DEFAULT NULL,
  `is_notify` tinyint(4) DEFAULT 1,
  `user_disclimer` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
