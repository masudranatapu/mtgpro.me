                ...
                <div class="col-lg-6">
                    <div class="singel_pro_gallery">
                        {{-- <div class="gallery_single carousel carousel-main">
                            ...
                            <div class="carousel-cell">
                                <img src="{{ asset(getPhoto($images->image_name)) }}" class="img-fluid" alt="image">
                            </div>
                            @endforeach
                        </div>
                                ...
                                <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff"
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide swiper-slide-prev" role="group" aria-label="1 / 2"
                                            style="width: 814px; margin-right: 10px;">
                                            <img src="{{ asset(getPhoto($images->image_name)) }}"
                                                style="width: 640px; height: 480px;" alt="product-img">
                                        </div>
                                        @endforeach
                                    </div>
                                ...
                                <div thumbsSlider="" class="swiper mySwiper">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 2"
                                            style="width: 125.667px; margin-right: 12px;">
                                            <img style="width: 100px; height: 100px;"
                                                src="{{ asset(getPhoto($images->image_name)) }}" alt="product-img">
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                        ...
                        <form action="{{ route('addtocart') }}" method="post" id="quanityForm">
                            ...
                            <div class="qtyfield mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="qty" id="qty" class="text-center custome_control"
                                        value="{{ session('cart')[$product->id]['quantity'] ?? 0 }}" min="0" max="10"
                                        readonly>
                                    <span class="input-group-btn">
