                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" autocomplete="off" name="title"
                                                    ...
                                                    placeholder="Tutorial title" required value="{{ $tutorial->title }}">
                                                @error('title')
                                        ...
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" autocomplete="off" name="publish_date" id="datepicker"
                                                    ...
                                                    placeholder="Publish Date" required value="{{ date('m/d/Y', strtotime($tutorial->publish_date)) }}">
                                                @error('publish_date')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                                ...
                                                <select name="category_id" id="category" required class="form-control">
                                                    @foreach ($tutorialCategories as $category)
                                                        <option value="{{ $category->id }}"
                                                            @if ($tutorial->category_id == $category->id) selected @endif>
                                                            {{ $category->title }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="mb-2">
                                                ...
                                                <select name="status" id="status" required class="form-control">
                                                    <option value="1"
                                                        @if ($tutorial->status == 1) selected @endif>Pubilsh</option>
                                                    <option value="0"
                                                        @if ($tutorial->status == 0) selected @endif>Unpubilsh</option>
                                                </select>
                                                @error('status')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                            <div class="mb-2">
                                                ...
                                                <select name="file_type" class="form-control" id="tutorialsFileType"
                                                    ...
                                                    <option value="1" @if($tutorial->file_type == 1) selected @endif>Image</option>
                                                    <option value="2" @if($tutorial->file_type == 2) selected @endif>Video</option>
                                                    <option value="3" @if($tutorial->file_type == 3) selected @endif>Youtube video link</option>
                                                </select>
                                                @error('file_type')
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <div class="mb-2">
                                                ...
                                                <textarea name="short_description" required class="form-control" cols="30" style="height: 100px;"
                                                    placeholder="Short description" onkeyup="countChars(this);">{{ $tutorial->short_description }}</textarea>
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <div class="mb-2">
                                                ...
                                                <textarea name="discription" class="form-control summernote" id="discription" required>{{ $tutorial->content }}</textarea>
                                                @error('discription')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
