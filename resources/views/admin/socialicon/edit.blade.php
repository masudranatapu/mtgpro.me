                                    ...
                                    <form action="{{route('admin.social-icon.update', $socileicons->id)}}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <img id="output"
                                                    src="{{ asset($socileicons->icon_image ?? 'assets/img/no-image.jpg') }}"
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-6 mb-2">
                                                ...
                                                <select name="icon_group" id="icon_group" class="form-control">
                                                    <option value="Recommended" {{$socileicons->icon_group ==
                                                        'Recommended' ? 'selected' : '' }}>Recommended</option>
                                                    <option value="Contact" {{$socileicons->icon_group == 'Contact' ?
                                                        'selected' : '' }}>Contact</option>
                                                    <option value="Social Media" {{$socileicons->icon_group == 'Social
                                                        Media' ? 'selected' : '' }}>Social Media</option>
                                                    <option value="Music Media" {{$socileicons->icon_group == 'Music
                                                        Media' ? 'selected' : '' }}>Music Media</option>
                                                    <option value="Payment" {{$socileicons->icon_group == 'Payment' ?
                                                        'selected' : '' }}>Payment</option>
                                                    <option value="More" {{$socileicons->icon_group == 'More' ?
                                            ...
                                            <div class="col-md-6 mb-2">
                                                ...
                                                <input type="text" name="icon_name" class="form-control"
                                                    value="{{$socileicons->icon_name}}" placeholder="Icon name">
                                            </div>

                                            <div class="col-md-6 mb-2">
                                                <label for="" class="form-label">{{ __('Icon Title')}}</label>
                                                <input type="text" name="icon_title" class="form-control"
                                                    value="{{$socileicons->icon_title}}" placeholder="Icon Title">
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-2">
                                                ...
                                                <select name="type" class="form-control">
                                                    ...
                                                    <option value="{{ $typ }}" {{ $socileicons->type == $typ ?
                                                        'selected' : '' }} >{{ $typ }}</option>
                                                    @endforeach
                                                    @endif
                                            ...
                                            <div class="col-md-6 mb-2">
                                                ...
                                                <input type="text" name="main_link" class="form-control"
                                                    value="{{$socileicons->main_link}}"
                                                    placeholder="Enter main link (if type is username)">
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <label for="" class="form-label">{{ __('Icon Example')}}</label>
                                                <input type="text" name="example_text" class="form-control"
                                                    value="{{$socileicons->example_text}}" placeholder="Icon Example">
                                            </div>

                                            <div class="col-md-6 mb-2">
                                                <label for="" class="form-label">{{ __('Order Id')}}</label>
                                                <input type="number" name="order_id" class="form-control"
                                                    value="{{$socileicons->order_id}}" placeholder="Order id">
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <label for="" class="form-label">{{ __('Status')}}</label>
                                                <select name="status" class="form-control">
                                                    <option disabled>Select One</option>
                                                    <option @if($socileicons->status == 1) selected @endif value="1">{{
                                                        __('Active')}}</option>
                                                    <option @if($socileicons->status == 0) selected @endif value="0">{{
                                                        __('Inactive')}}</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                ...
                                                <select name="is_paid" class="form-control">
                                                    ...
                                                    <option value="0" @if($socileicons->is_paid == 0) selected @endif>{{
                                                        __('Free')}}</option>
                                                    <option value="1" @if($socileicons->is_paid == 1) selected @endif>{{
                                                        __('Paid')}}</option>
                                                </select>
                                            </div>
                                        </div>
