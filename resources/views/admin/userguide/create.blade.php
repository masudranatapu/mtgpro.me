            ...
            <div class="row row-deck row-cards">
                <div class="col-sm-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.user.guide.store') }}" method="post">
                                @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="description" id="summernote" class="form-control" cols="30" rows="5" value="{{old('description')}}" required></textarea>
                                                    @error('description')
                                                    <div class="text-danger">{{$message}}</div>
                                                    @enderror
                                                </div>
