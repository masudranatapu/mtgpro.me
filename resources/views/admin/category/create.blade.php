                ...
                <div class="col-sm-12 col-lg-12">
                    <form action="{{route('admin.category.store')}}" method="post" class="card">
                        ...
                        <div class="card-header">
                            ...
                            <div class="col">
                                <div class="float-end">
                                    <a href="{{route('admin.category.index')}}" class="btn btn-primary">{{ __('Back')}}</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="category_name" placeholder="{{ __('Enter category names')}}" value="{{old('category_name')}}">
                                                @error('category_name')
