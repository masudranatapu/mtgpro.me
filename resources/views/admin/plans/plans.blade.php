                                        ...
                                        <tbody>
                                            @foreach ($plans as $plan)
                                                <tr>
                                                    ...
                                                    <td class="text-muted">
                                                        @if ($plan->status == 0)
                                                            <span class="badge bg-red">{{ __('Unpublish') }}</span>
                                                        @else
                                                            <span class="badge bg-green">{{ __('Publish') }}</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-muted">
                                                        @if (!empty($gateway))
                                                        ...
                                                        <div class="btn-list flex-nowrap">
                                                            ...
                                                            @if ($plan->status == 0)
                                                                <a class="btn btn-sm btn-warning" href="#"
                                                                    onclick="getPlan('{{ $plan->plan_id }}'); return false;">{{ __('Publish') }}</a>
                                                            @else
                                                                <a class="btn btn-sm btn-warning" href="#"
                                                                    onclick="getPlan('{{ $plan->plan_id }}'); return false;">{{ __('Unpublish') }}</a>
                                                            @endif
                                                        </div>
                                                    </td>
                                                </tr>
