                    ...
                    <div class="card invoice_wrap" id="printableArea">
                        ...
                        <div class="card-body" style="padding-left: 5%; padding-right:5%">
                            <div class="row mb-3">
                                <div class="col-6">
                                    <div class="logo">
                                        <img src="{{ asset('assets/uploads/logo/arobil_logo_70x70-63b2d1dd8e53e.png') }}"
                                            width="100" alt="">
                                    </div>
                                </div>
                                <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="invoice_title float-start">
                                            ...
                                            <p><b>Date:
                                                    {{ date('d M Y', strtotime($orderTransactions->transaction_date)) }}</b>
                                            </p>

                                            <p>Status: <strong
                                                    class="text-success">{{ $orderTransactions->payment_status }}</strong>
                                            </p>
                                        </div>
                                    </div>
                                    @php
                                ...
                                <table class="invoice_table table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ getPrice($total = $orderDetails->unit_price * $orderDetails->quantity) }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"></td>
                                        ...
                                        <tr>
                                            <td>Currency:
                                                <strong>{{ $orderTransactions->transaction_currency }}</strong></td>
                                            <td colspan="1"></td>
                                            <td><strong>Grand Total:</strong></td>
                                            <td><strong>
                                                    {{ getPrice($totalPayment = $total + $invoiceOrder->payment_fee) }}
                                                    AUD</strong></td>
                                        </tr>
                                        <tr class="bg-default">
                                            <td>Payment Method:
                                                <strong>{{ $orderTransactions->payment_gateway_name }}</strong></td>
                                            <td colspan="1"></td>
