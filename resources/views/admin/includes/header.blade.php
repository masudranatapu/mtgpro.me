                ...
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    <span class="">
                        @if (Auth::user()->profile_image)
                            <img src="{{ asset(Auth::user()->profile_image) }}" alt="{{ auth::user()->name }}" class="avatar avatar-sm avatar-rounded">
                        @else
                            <img src="{{ asset('assets/img/avatar/1.jpg') }}" alt="{{ auth::user()->name }}" class="avatar avatar-sm avatar-rounded">
                        @endif
                    </span>
