        ...
        <div class="navbar menu_bar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item @yield('porducts')">
                    ...
                    <li class="nav-item dropdown @yield('settings') @yield('email-template') @yield('tutorials_category') @yield('tutorials') @yield('setting') ">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="{{ route('admin.tutorialcategory.index') }}" class="dropdown-item @yield('tutorials_category')">{{
                                __('Tutorials Category') }}</a>


                            <a href="{{ route('admin.tutorials.index') }}" class="dropdown-item @yield('tutorials')">{{
                                __('Tutorials') }}</a>
