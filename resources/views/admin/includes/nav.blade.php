        ...
        <div class="navbar menu_bar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li
                        class="nav-item dropdown @yield('plans')">
                ...
                <li class="nav-item dropdown @yield('settings')">
                    <a class="nav-link dropdown-toggle" href="#navbar-extra" data-bs-toggle="dropdown" role="button" aria-expanded="false">
                        ...
                        <div class="dropdown-menu">
                            <a href="{{ route('admin.settings') }}" class="dropdown-item @yield('setting')">{{ __('General Settings') }}</a>
                            <a href="{{ route('admin.payment.methods') }}" class="dropdown-item @yield('payment_method')">{{ __('Payment Methods') }}</a>
                            <a href="{{ route('admin.transactions') }}" class="dropdown-item @yield('transaction')">{{ __('Transactions') }}</a>
                            <a href="{{ route('admin.pages') }}" class="dropdown-item @yield('page')">{{ __('Pages') }}</a>
                            <a href="{{ route('admin.custom-page.list') }}" class="dropdown-item @yield('custom_page_list')">{{ __('Custom Pages') }}</a>
                            <a href="{{ route('admin.faq.list') }}" class="dropdown-item @yield('faq')">{{ __('Faqs') }}</a>
