                    ...
                    <div class="col-lg-7 col-12">
                        @if (!empty($banner['banner_video']) && file_exists(public_path($banner['banner_video'])))
                            <div class="embed-responsive embed-responsive-21by9">
                                <video class="embed-responsive-item banner-video" loop="true" autoplay="autoplay"
                                    controls muted preload="none">
                                    <source src="{{ asset($banner['banner_video']) }}" type="video/mp4">
                                    {{--
                        <source src="movie.ogg" type="video/ogg"> --}}
                                    <img src="{{ asset($banner['banner_photo']) }}"
                                        alt="{{ strip_tags($banner['banner_title']) }}">
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="flush-headingOne__{{ $key }}">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                data-bs-target="#flush-collapseOne__{{ $key }}"
                                                aria-expanded="false"
                                                aria-controls="flush-collapseOne__{{ $key }}">
                                                {{ __($faq->title) }}
                                            </button>
                                        </h2>
                                        <div id="flush-collapseOne__{{ $key }}"
                                            class="accordion-collapse collapse"
                                            aria-labelledby="flush-headingOne__{{ $key }}"
