                    ...
                    <div class="login_content">
                        <div class="login_header mb-5 text-center">
                            <a href="{{ route('home') }}"><img src="{{ asset($settings->site_logo) }}" class="img-fluid"
                                    alt="{{ $settings->site_name }}" title="{{ $settings->site_name }}"></a>
                        ...
                        <div class="login_form">
                            <form action="{{ route('user.reset.new.password') }}" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label for="password" class="col-form-label text-md-right">{{ __('New Password')
                                            }}</label>
                                ...
                                <div class="mt-4 mb-3">
                                    <button type="submit" class="btn btn-primary w-100">{{ __('Save
                                        Password')}}</button>
                                </div>
                            </form>
                        </div>
