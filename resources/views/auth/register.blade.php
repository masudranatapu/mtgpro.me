                        ...
                        <div class="login_form">
                            ...
                            <form method="POST" action="{{ route('post-register') }}">
                                ...
                                <div class="social_login mb-2 mt-2 text-center">
                                    <a href="{{ route('social.login', 'facebook') }}" class="fa_facebook"><i
                                            class="fab fa-facebook"></i></a>
                                    <a href="{{ route('social.login', 'google') }}" class="fa_google"><i
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        tabindex="1" placeholder="{{ __('Full Name') }}" required>
                                    @if ($errors->has('name'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" id="email"
                                        ...
                                        value="{{ old('email') }}" tabindex="2" placeholder="{{ __('Email address') }}"
                                        required>
                                    @if ($errors->has('email'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="username" id="username"
                                        ...
                                        value="{{ old('username') }}" tabindex="2" placeholder="{{ __('Username') }}"
                                        required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="password_confirmation" id="password_confirmation"
                                        ...
                                        tabindex="4" placeholder="{{ __('Confirm Password') }}" required>
                                ...
                                <div class="bottom text-center">
                                    <p>{{ __('Already have an Account?') }} <a href="{{ route('login') }}"
                                            title="{{ __('Sign In') }}">{{ __('Sign In') }}</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
