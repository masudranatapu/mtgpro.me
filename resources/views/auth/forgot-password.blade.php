                ...
                <div class="col-sm-9 col-md-7 col-lg-5 col-xl-4">
                    <div class="login_content">
                        <div class="login_header mb-5 text-center">
                            <a href="{{ route('home') }}"><img src="{{ asset($settings->site_logo) }}" class="img-fluid"
                                    title="{{ $settings->site_name }}" alt="{{ $settings->site_name }}"></a>
                            <h6>{{ __("Enter your account email and we'll send you a link to reset your password.")}}
                            </h6>
                        </div>
                        <div class="login_form">
                            ...
                            <form action="#" method="post">
                                ...
                                <div class="mt-4 mb-3">
                                    <button type="submit" class="btn btn-primary w-100">{{ __('Send Reset
                                        Link')}}</button>
                                </div>
                            </form>
                        </div>
