                    ...
                    <div class="login_form">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" tabindex="1" placeholder="{{ __('Email address') }}" required>
                                @if($errors->has('email'))
