                    ...
                    <div class="footer_widget">
                        ...
                        <div class="footer_menu">
                            <ul>
                                ...
                                <li><a target="__blank" href="{{ route('privacy-policy') }}">{{ __('Privacy Policy') }}</a></li>
                                <li><a target="__blank" href="{{ route('terms-conditions') }}">{{ __('Terms & Conditions') }}</a></li>
                                <li><a target="__blank" href="{{ route('data-deletion-instructions') }}">{{ __('Data deletion instructions') }}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
