                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p>
                                            <strong>Purpose of Mortgage or Loan :</strong>

                                            <span>{{ $userData['purpose'] }}</span>

                                        </p>
                                        @if ($userData['purpose'] == 'Purchase')
                                            <p>
                                            ...
                                            <p>
                                                ...
                                                <span>{{ $userData['down_amount'] }}</span>
                                            </p>
                                        @endif
                                        @if ($userData['purpose'] == 'Refinance')
                                            <p>
                                        ...
                                        <p>
                                            ...
                                            <span>{{ $userData['property_type'] }}</span>
                                        </p>
                                        <p>
                                        ...
                                        @if (isset($userData['company_name']))
                                            <p>
                                                <strong>Current Mortgage Company :</strong>
                                                <span>{{ $userData['company_name'] }}</span>
                                            </p>
                                        @endif
                                        <p>
                                            <strong>Referral to a Real Estate Agent :</strong>
                                        ...
                                        <p>
                                            <strong>Employed by your current
                                                emmployer :</strong>
                                            <span>{{ $userData['current_employer'] }}</span>
                                        </p>
                                        <p>
                                            <strong>Annual Income :</strong>
                                            <span>{{ $userData['annual_income'] }}</span>
                                        </p>
                                        <p>
                                            <strong>Credit Score :</strong>
                                            <span>{{ $userData['credit_score'] }}</span>
                                        </p>
