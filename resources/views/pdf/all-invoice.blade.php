...
<body>
    @foreach ($rows as $row)
        ...
        <div class="setting_sec section mt-3 mb-5"
            @if (!empty($row)) style="page-break-after:always;" @endif>
            <div class="container">
                <div class="row">
                    <div class="col-12">
                                ...
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="text-align: left;">INVOICE NO :
                                                    {{ $row->invoice_prefix }}-{{ $row->gobiz_transaction_id }}</td>
                                    ...
                                    <table
                                        ...
                                        <tbody
                                            ...
                                            <tr style="border-color: inherit;border-style: solid;border-width: 0;">
                                                <td colspan="4"
                                                    style="border-bottom: 1px solid #ccc;padding: 0.5rem 0.5rem;">Tax
                                                    Amount</td>
                                                <td
                                            ...
                                            <tr style="border-color: inherit;border-style: solid;border-width: 0;">
                                                <td colspan="4"
                                                    style="border-bottom: 1px solid #ccc;padding: 0.5rem 0.5rem;">Total
                                                </td>
                                                <td
