                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-body custom_table">
                            <div class="px-2 py-2">
                                <table id="dataTable" class="table table-vcenter table-responsive card-table"
                                    id="table-plan">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img class="custom_image" src="{{ $marketing_materials_details->image }}"
                                                    alt="Paris">
                                            </td>
                                            <td>
                                                @if ($marketing_materials_details->file)
                                                    <a class="" href="{{ $marketing_materials_details->file }}"
                                                        download><i class="fa-solid fa-arrow-down"></i> Download</a>
                                                @endif
                                            </td>
                                        </tr>
                                        {{-- @endif --}}
