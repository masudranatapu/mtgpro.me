                        ...
                        <ul>
                            <li>
                                <a href="#" target="_blank">
                                    <svg width="75" height="75" fill="#1877F2" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 80 80">
                                        <g clip-path="url(#facebook_monochrome_svg__facebook)"
                                            filter="url(#facebook_monochrome_svg__filter0_i)">
                                            <path
                                        ...
                                        <defs>
                                            <clipPath id="facebook_monochrome_svg__facebook">
                                                <path fill="#fff" d="M0 0h80v80H0z"></path>
                                            </clipPath>
                                            <filter id="facebook_monochrome_svg__filter0_i" x="0" y="-1"
                                                width="80" height="81" filterUnits="userSpaceOnUse"
                            ...
                            <li>
                                <a href="#" target="_blank">
                                    <svg width="75" height="75" fill="#0077B5" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 80 80">
                                        <g filter="url(#linkedin_monochrome_svg__filter0_i)">
                                            <path
                                                d="M18.095 0h43.81C71.905 0 80 8.095 80 18.095v43.81C80 71.905 71.905 80 61.905 80h-43.81C8.095 80 0 71.905 0 61.905v-43.81C0 8.095 8.095 0 18.095 0z">
                                            </path>
                                            <path
                                        ...
                                        <defs>
                                            <filter id="linkedin_monochrome_svg__filter0_i" x="0" y="-1"
                                                width="80" height="81" filterUnits="userSpaceOnUse"
                                                color-interpolation-filters="sRGB">
                                                <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
                                                <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape">
                            ...
                            <li>
                                <a href="#" target="_blank">
                                    <svg width="75" height="75" fill="#F41314" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 80 80">
                                        <g clip-path="url(#facebook_monochrome_svg__facebook)"
                                            filter="url(#facebook_monochrome_svg__filter0_i)">
                                            <path
                            ...
                            <li>
                                <a href="#" target="_blank">
                                    <svg width="75" height="75" fill="#C92591" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 80 80">
                                        <g filter="url(#instagram_monochrome_svg__filter0_i_3117_2479911)">
                                            <path
                                                d="M18.095 0h43.81C71.905 0 80 8.095 80 18.095v43.81C80 71.905 71.905 80 61.905 80h-43.81C8.095 80 0 71.905 0 61.905v-43.81C0 8.095 8.095 0 18.095 0z">
                                            </path>
                                            <path
                                        ...
                                        <defs>
                                            <filter id="instagram_monochrome_svg__filter0_i_3117_2479911" x="0"
                                                y="-1" width="80" height="81"
                            ...
                            <li>
                                <a href="#" target="_blank">
                                    <svg class="icon-shadow" width="75" height="75" viewBox="0 0 80 80"
                                        ...
                                        <defs>
                                            <filter id="filterc8" x="0" y="-1" width="80"
                                            ...
                                            <linearGradient id="paint0_linearc8" x1="40" y1="0"
                                                x2="40" y2="80" gradientUnits="userSpaceOnUse">
                            ...
                            <li>
                                <a href="mailto:rabin1@gmail.com" target="_blank">
                                    <svg class="icon-shadow" width="75" height="75" viewBox="0 0 80 80"
                                        ...
                                        <defs>
                                            <filter id="filterc9" x="0" y="-1" width="80"
                                                height="81" filterUnits="userSpaceOnUse"
                                                color-interpolation-filters="sRGB">
                                                <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
                                                <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix"
                                            ...
                                            <linearGradient id="paint0_linearc9" x1="40" y1="0"
                                                x2="40" y2="80" gradientUnits="userSpaceOnUse">
