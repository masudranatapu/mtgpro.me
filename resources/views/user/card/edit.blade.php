                                                ...
                                                <div class="text-left">{{ __('Equal Housing Logo Show') }}
                                                    ...
                                                    border: 1px solid #EEE;">
                                                        ...
                                                        <input id="yes" name="housingLogo" class="switcher_"
                                                            type="radio" value="1" @if (Auth::user()->housing_logo_view
                                                        == '1') checked @endif>

                                                        <input id="no" name="housingLogo" class="switcher_" type="radio"
                                                            value="0" @if (Auth::user()->housing_logo_view == '0')
                                                        checked @endif>
                                            ...
                                            <div class="plan_type switchBtn text-center mb-4 mt-3">
                                                <div class="text-left">{{ __('User Disclaimer Show') }}
                                                    ...
                                                    border: 1px solid #EEE;">
                                                        ...
                                                        <input id="disclaimer_show" name="disclaimer" class="switcher_"
                                                            type="radio" value="1" @if (Auth::user()->disclaimer_view ==
                                                        '1') checked @endif>

                                                        <input id="disclaimer_hide" name="disclaimer" class="switcher_"
                                                            type="radio" value="0" @if (Auth::user()->disclaimer_view ==
                                                        '0') checked @endif>
                                            ...
                                            <div class="plan_type switchBtn text-center mb-4 mt-3">
                                                <div class="text-left">{{ __('User nmls Show') }}
                                                    ...
                                                    border: 1px solid #EEE;">
                                                        ...
                                                        <input id="nmls_show" name="nmls" class="switcher_" type="radio"
                                                            value="1" @if (Auth::user()->nmls_view == '1') checked
                                                        @endif>

                                                        <input id="nmls_hide" name="nmls" class="switcher_" type="radio"
                                                            value="0" @if (Auth::user()->nmls_view == '0') checked
                                                        @endif>
                                            ...
                                            <form action="{{ route('user.nmls.add') }}" method="post">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <label for="" class="form-label text-left">NMLS
                                                        ID</label>
                                                    <input type="text" class="form-control required @error('nmls_id')
                                                            border-danger
                                                        @enderror" name="nmls_id" required
                                                ...
                                                <div class="text-left">{{ __('Credit Authorization') }}
                                                    ...
                                                    border: 1px solid #EEE;">
                                                        ...
                                                        <input id="credit_auth_show" name="credit_auth"
                                                            ...
                                                            @if(Auth::user()->credit_authorization == '1') checked
                                                        @endif>

                                                        <input id="credit_auth_hide" name="credit_auth"
                                                            class="switcher_" type="radio" value="0"
                                                            @if(Auth::user()->credit_authorization == '0') checked
                                                        @endif>
