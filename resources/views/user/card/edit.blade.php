                                            ...
                                            <div class="card_content text-center">
                                                ...
                                                <div class="save_contact mt-4 mb-4">
                                                    <div class="d-flex" style="justify-content: space-evenly;">
                                                        <div class="">
                                                            <a href="javascript:void(0)"
                                                                class="sp text-decoration-none d-inline-block btn-secondary">{{ __('Save Contact') }}</a>
                                                        </div>
                                                        <div class="">
                                                            <a href="javascript:void(0)"
                                                                class="sp text-decoration-none d-inline-block btn-secondary">
                                                                {{ __('Share') }}
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="row icon_append">
                                                        <div class="col-4 mb-2">
                                                            <a href="javascript:void(0)" data-bs-toggle="offcanvas"
                                                                ...
                                                                <img style="border-radius: 15px; margin:0 auto; @if ($card->color_link == 1) background:{{ $card->theme_color }} @else background:#A93998  @endif"
