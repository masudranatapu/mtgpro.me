                                        ...
                                        <div class="row pb-3">
                                            <div class="col-sm-6 pb-5 pb-sm-0">
                                                ...
                                                <address>
                                                    ...
                                                    <span class="d-block">
                                                        {{ $invoice_details->from_billing_address }}</span>
                                                    <span class="d-block">
                                                    ...
                                                    <span class="d-block">
                                                        {{ $invoice_details->from_billing_email }}</span>
                                                    <span class="d-block">
                                                        {{ $invoice_details->from_billing_phone }}</span>
                                            ...
                                            <div class="col-sm-6 text-sm-right">
                                                ...
                                                <span>INVOICE DATE :
                                                    {{ date('d-m-Y H:i A', strtotime($row->transaction_date)) }}</span>
                                            </div>

                                        </div>
                                        <div class="table-responsive">
                                            <table class="table table-transparent" style="min-width:750px;">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="4"
                                                            class="title font-weight-bold text-uppercase text-end">Total
                                                        </td>
