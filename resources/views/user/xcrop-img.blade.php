...
<div class="content-wrapper">
    ...
    <div class="content">
        <form class="form-horizontal" method="POST" action="{{ route('user.card.crop-upload') }}" accept-charset="UTF-8"
            enctype="multipart/form-data">
            @csrf
            <div>
                <div class="frame" style="width:360px;height:240px" data-size="360,360" data-max-file-size="2">
