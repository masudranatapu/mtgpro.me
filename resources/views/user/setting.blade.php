                                                ...
                                                <form action="{{ route('user.profile-info.update') }}"
                                                    ...
                                                    <div class="form-group mt-4">
                                                        <label class="form-label" for="user_disclimer">
                                                            {{ __('Disclaimer') }}</label>
                                                        <textarea required name="user_disclaimer" id="user_disclimer"
                                                            cols="30" rows="10" class="form-control">{{ old('user_disclimer') ?? $user->user_disclaimer }}
                                                            </textarea>
